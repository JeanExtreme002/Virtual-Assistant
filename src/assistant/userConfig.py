...
class UserConfig(object):
    ...
    def __get_user_command_filename(self):
    ...
    def __save_to_file(self, command_dict):
        with open(self.__get_user_command_filename(), "w") as file:
    ...
    def delete_user_commands(self):
        os.remove(self.__get_user_command_filename())

    def get_command_list(self):
        filename = self.__get_user_command_filename()
